...
curl https://raw.githubusercontent.com/con0101/Kali-Mods/refs/heads/main/firefox/policies.json -o policies.json
rm /usr/share/firefox-esr/distribution/policies.json
mv policies.json /usr/share/firefox-esr/distribution/policies.json
